...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Log the error for debugging and set the form status to error
      console.error(error);
      setFormStatus("error");
    }
  };
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            {/* Contact Information */}
            <div className="space-y-8 border border-gray-200 dark:border-gray-700 rounded-2xl p-4">
              <div>
                <h2 className="text-3xl lg:text-4xl font-black text-gray-900 dark:text-gray-100 mb-4">
                  Contact Information
                </h2>
                ...
                {[
                  {
                    icon: EnvelopeIcon,
                    title: "Email Us",
                    content: "support@medhasetu.com",
                    subContent: "We typically respond within 2-4 hours",
                    action: "mailto:support@medhasetu.com",
                  },
                  {
                    icon: PhoneIcon,
                    title: "Call Us",
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  {[
                    {
                      platform: "LinkedIn",
                      href: "https://www.linkedin.com/in/ramharsh-sanjay-dandekar/",
                    },
                    {
                      platform: "GitHub",
      ...
      <section className="py-24 bg-gradient-to-br from-emerald-500 via-teal-600 to-blue-600 relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl lg:text-2xl text-white/90 mb-12 font-medium leading-relaxed max-w-3xl mx-auto">
            Join thousands of healthcare providers who trust MedhaSetu to
