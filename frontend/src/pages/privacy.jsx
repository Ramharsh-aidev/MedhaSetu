        ...
        <main className="max-w-4xl mx-auto px-6 py-12 space-y-8 flex-1">
          <section>
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              Welcome to MedhaSetu. Your privacy is important to us. This Privacy
          ...
          <section>
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              MedhaSetu implements industry-standard security measures, including
          ...
          <section>
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              ...
              at{" "}
              <a
                href="mailto:privacy@MedhaSetu.com"
                className="text-primary hover:underline"
              >
                privacy@MedhaSetu.com
              </a>
              .
            </p>
          </section>
