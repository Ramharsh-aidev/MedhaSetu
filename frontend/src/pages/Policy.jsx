      ...
      <section className="relative py-24 bg-gradient-to-br from-emerald-50 via-white to-teal-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              Understanding how MedhaSetu uses cookies to enhance your healthcare platform experience while protecting your privacy and data.
            </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <motion.button
                  ...
                  className="border-2 border-emerald-500 dark:border-emerald-400 text-emerald-600 dark:text-emerald-400 px-6 py-3 rounded-xl hover:bg-emerald-50 dark:hover:bg-emerald-900/20 font-semibold transition-all duration-300"
                >
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm mt-4">
              Your preferences will be saved and applied across all MedhaSetu services
            </p>
          </motion.div>
        </div>
      </section>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-blue-800 dark:text-blue-200 leading-relaxed">
                    Disabling all cookies may affect website functionality and your ability to access certain features of the MedhaSetu platform. Essential cookies are necessary for security and basic functionality.
                  </p>
                </div>
              </div>
            </motion.div>
