  ...
  const values = [
    {
      ...
      description: "Developed by Ramharsh Sanjay Dandekar with passion for healthcare innovation and technology.",
    ...
    },
    {
      icon: LightBulbIcon,
      title: "Innovation",
      description: "Leveraging cutting-edge technology to solve real healthcare challenges through modern development.",
      color: "from-yellow-500 to-orange-500"
    },
    {
      icon: UserGroupIcon,
      title: "Healthcare Focused",
      description: "Designed specifically for healthcare providers and patients with AI-powered features.",
  ...
  const team = [
    {
      ...
      image: "👨‍💻",
      bio: "Passionate healthcare technology developer creating innovative solutions for better patient care",
      specialties: ["Full Stack Development", "Healthcare Tech", "AI Integration"]
    },
    {
      name: "Healthcare Focus",
      role: "Project Vision",
      image: "🏥",
      bio: "Dedicated to improving healthcare accessibility through innovative technology solutions",
      specialties: ["Healthcare Technology", "AI Integration", "Patient Care"]
    },
    {
      name: "Modern Technology",
      role: "Technical Foundation",
      image: "🚀",
      bio: "Built with latest technologies for optimal performance and user experience",
    ...
    },
    {
      ...
      role: "Core Mission",
      image: "�",
      bio: "Focused on creating innovative solutions for healthcare providers and patients",
      specialties: ["Digital Health", "Patient Management", "Medical Technology"]
    }
  ];

  // Project development milestones
  const milestones = [
    { year: "2024", title: "Project Inception", description: "MedhaSetu started as Ramharsh's personal healthcare management solution" },
    { year: "2025", title: "Core Development", description: "Development of core healthcare management features and AI integration" },
    { year: "2025", title: "Feature Enhancement", description: "Added advanced features like pharmacy mapping and AI health assistant" },
    { year: "2025", title: "Beta Release", description: "Launch of beta version with comprehensive healthcare management tools" },
    { year: "2025", title: "Continuous Innovation", description: "Ongoing development and feature improvements for better user experience" }
  ];
      ...
      <section className="relative py-24 bg-gradient-to-br from-emerald-50 via-white to-teal-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900 overflow-hidden pt-20">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              🏥 Personal Healthcare Project • By Ramharsh Sanjay Dandekar
            </motion.div>
            ...
            >
              A comprehensive healthcare management platform developed by Ramharsh Sanjay Dandekar, connecting patients, doctors, and pharmacies with innovative, secure technology.
            </motion.p>
            ...
            >
              {["Personal Project", "Healthcare Innovation", "Modern Technology"].map((text, index) => (
            ...
            >
              <motion.a
                href="https://github.com/Ramharsh-aidev/MedhaSetu"
                target="_blank"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-shadow duration-300">
                ...
                <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                  To revolutionize healthcare technology by creating innovative digital solutions that streamline healthcare management, improve patient care, and bridge the gap between patients and providers.
                </p>
              </div>
            </motion.div>
            ...
            >
              <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-shadow duration-300">
                ...
                <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                  A future where healthcare management is seamless, efficient, and patient-centered, powered by intelligent technology that makes quality healthcare accessible to everyone.
                </p>
              </div>
            </motion.div>
          </div>
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              The principles that drive our healthcare innovation platform
            </motion.p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              ...
              >
                <div className={`bg-white dark:bg-gray-800 rounded-2xl p-8 h-full shadow-lg hover:shadow-2xl transition-all duration-300 border-2 ${activeValue === index ? 'border-emerald-200 dark:border-emerald-800' : 'border-transparent'} hover:border-emerald-200 dark:hover:border-emerald-800`}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.p 
              ...
              className="text-xl text-gray-600 dark:text-gray-300"
            >
              Meet the Developer Behind MedhaSetu
            </motion.p>
          </motion.div>
      ...
      <section className="py-20 bg-gradient-to-br from-emerald-500 via-teal-600 to-blue-600 relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              Ready to Experience Modern Healthcare Technology?
            </motion.h2>
            <motion.p 
              variants={itemVariants}
              className="text-xl lg:text-2xl text-white/90 mb-12 font-medium leading-relaxed max-w-3xl mx-auto"
            >
              Discover how MedhaSetu revolutionizes healthcare management with AI-powered features, seamless appointment scheduling, and comprehensive patient care tools.
            </motion.p>
