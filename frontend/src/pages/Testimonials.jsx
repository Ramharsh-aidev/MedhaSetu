  ...
  const testimonials = [
    {
      ...
      content:
        "MedhaSetu has revolutionized how I manage my patients. The AI-powered insights help me make better diagnoses, and the seamless communication with pharmacists ensures my patients get the right medications quickly.",
      rating: 5,
    },
    {
      name: "Vikash Gupta",
    ...
    },
    {
      ...
      content:
        "As someone with chronic conditions, MedhaSetu has been a lifesaver. I never miss medications thanks to smart reminders, and I can easily track my health progress and communicate with my care team.",
      rating: 5,
    },
    {
      name: "Dr. Amit Singh",
    ...
    },
    {
      ...
      content:
        "MedhaSetu integrates seamlessly with our existing systems. The analytics help in identifying patient trends effectively.",
      rating: 5,
    },
    {
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        ...
        >
          ...
          <p className="text-xl lg:text-2xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto leading-relaxed">
            Join thousands of healthcare professionals who trust MedhaSetu to
