  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        // Show success toast
        toast.success(
          `Welcome to MedhaSetu, ${formData.firstName}! Your account has been created successfully. Redirecting to your dashboard...`,
          {
            duration: 4000,
            icon: "🎉",
          }
      ...
      >
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            ...
            <p id="phone-help" className="text-xs text-gray-500 mt-1 px-1">
