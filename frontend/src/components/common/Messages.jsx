...
const Messages = () => {
  ...
  useEffect(() => {
    const initializeMessaging = async () => {
      ...
      if (!token || !user.isBackendUser) {
        ...
        setLoading(false);
        setError('Please log in with your MedhaSetu account to access messaging');
        return;
      }
  ...
  const handleSendMessage = async (e) => {
    ...
    if (!token || !user.isBackendUser) {
      ...
      setError('Please log in with your MedhaSetu account to send messages');
                ...
                <>
                  ...
                  <div className="p-4 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700">
                    ...
                    {localStorage.getItem('token') && user?.isBackendUser ? (
                      ...
                      <div className="text-xs text-orange-600 mt-1">Please log in with MedhaSetu account for messaging</div>
                    )}
                  </div>
                </>
              );
